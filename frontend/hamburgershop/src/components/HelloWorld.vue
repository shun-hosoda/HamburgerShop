...
<script lang="ts">
  ...
  export default class HellowWorld extends Vue{
    ...
    created(){
      this.getMenuData()
      // this.orderTypes.push(this.orderType1)
      // this.orderTypes.push(this.orderType2)
      // this.paymentTypes.push(this.paymentType1)
      // this.paymentTypes.push(this.paymentType2)
      // this.paymentTypes.push(this.paymentType3)
      // this.taxTypes.push(this.taxType1)
      // this.taxTypes.push(this.taxType2)
      // this.items.push(this.item1)
      // this.items.push(this.item2)
      // this.items.push(this.item3)
      // this.items.push(this.item4)
      // const defaultOrderType = this.orderTypes.find((x) => x.id === this.orderTypeRadio)
      // const taxType = this.taxTypes.find((x) => x.id === defaultOrderType?.taxId)
      // this.taxRate = taxType === undefined ? 0 : taxType.rate
      // this.items.forEach((x) => {
      //   x.taxIncludedPrice = Math.floor(x.unitPrice + (x.unitPrice * this.taxRate))
      // })
    }
    async purchase(){
